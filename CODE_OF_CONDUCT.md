...
**conduct@fteqw.dev** (replace with actual contact)
...
1. **Document the incident** with screenshots, logs, or other evidence
2. **Contact community leaders** at conduct@fteqw.dev
...
All reports will be kept confidential and handled with care.
...
- **Be patient**: Remember that people have different levels of experience
  and may need time to learn
- **Be considerate**: Your work will be used by other people, and you in turn
  will depend on the work of others

Together, we can build a game engine that serves everyone! 🎮
